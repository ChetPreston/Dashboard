...
set checkout_folder_name="GEEx_console"
set checkout_URL="https://subversion.blueorigin.com/svn/operations-software/blue_test_stands/deliverables/released/GEEx_console"
set step2_batch_path=".\batch_files\GEEx_console_released_step2.bat"
