...
set checkout_folder_name="XEEx_console"
set checkout_URL="https://subversion.blueorigin.com/svn/operations-software/blue_test_stands/deliverables/released/XEEx_console"
set step2_batch_path=".\batch_files\XEEx_console_released_step2.bat"
